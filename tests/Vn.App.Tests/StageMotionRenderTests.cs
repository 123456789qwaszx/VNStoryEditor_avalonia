...
///
/// 접힌 자리는 이동이 <em>끝난</em> 자리라, 그것만 그리면 화면에서 캐릭터가 움직였다는
/// 사실 자체가 안 보인다. 그래서 정지 프레임을 <b>출발 자리</b>로 세우고 타임라인·재생이
/// 그 길을 태운다 — 그 두 가지가 진짜 시각 트리에서 일어나는지 확인하는 것이 이 테스트다.
/// (출발·도착을 겹쳐 그리던 노란 고스트와 점선 궤적은 2026-08-21에 걷혔다 — 그때 궤적
/// 전용 테스트 둘도 함께 삭제됐다.)
/// </summary>
